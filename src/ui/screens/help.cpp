...
// non-radio providers S/P/C/M/J/E/B/Q/T, provider browser N, o/t,
...
// Giereś archive browser, docs/orgonity-api.md; y is bootamp's YouTube
// browser — search / playlists / feeds via resolve_ytdl).
std::vector<HelpEntry> build_entries() {
  ...
  add("y", "Open YouTube browser (search / playlists / feeds)");
